...
#define do_div(n,base) ({ int __res; __res = ((unsigned long long) n) % (unsigned) base; n = ((unsigned long long) n) / (unsigned) base; __res; })
...
static wchar_t *number (wchar_t *str, long long num, int base, int size, int precision, int type)
{
